...
import { section } from "../../utils/RegistryEntryText";
    ...
    export default function Register() {
        const [numSection, setNumSection] = useState(1);
        ...
        return (
            <TouchableWithoutFeedback onPress={dismissKeyboard}>
                <ScrollView 
                    ...
                    <Box>
                        {numSection == 2 && <Text color="blue.800" fontWeight='bold' fontSize='lg' mt={2} mb={2}> 
                    ...
                    {numSection > 0 && 
                        (<ButtonComponent onPress={() => backSection()} bgColor="gray.400">
                            Go Back
                        </ButtonComponent>)}
